                    ...
                    <div>
                        <div className="avis">
                            <div className="container">
                                <div className="head-avis"><Stars
                                    value={this.state.avis[this.state.page].notes.global} /> <span
                                    className="pseudo">par {this.state.avis[this.state.page].pseudo ? this.state.avis[this.state.page].pseudo : 'un stagiaire'}</span>
                                </div>
                            ...
                            <div className="date">Session
                                du {moment(this.state.avis[this.state.page].startDate).format('DD/MM/YYYY')}
