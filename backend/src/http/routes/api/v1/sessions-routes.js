...
module.exports = ({ middlewares, reconciliation }) => {
    ...
    router.get('/v1/sessions', checkAuth, tryAndCatch(async (req, res) => {
        ...
        let stream = await reconciliation.getDocumentsAsStream('session', parameters, {
    ...
    router.get('/v1/sessions/:id', checkAuth, tryAndCatch(async (req, res) => {
        ...
        let dto = await reconciliation.getDocument('session', parameters, {
    ...
    router.get('/v1/sessions/:id/avis', checkAuth, tryAndCatch(async (req, res) => {
        ...
        let avis = await reconciliation.getAvis('session', parameters);
