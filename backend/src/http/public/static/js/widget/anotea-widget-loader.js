...
(function() {
    ...
    function getStyles() {
        var css = '.anotea-widget-iframe{ width: 1px; min-width: 100%;}';
    ...
    /* eslint-disable  */
    //Fork of https://github.com/davidjbradshaw/iframe-resizer to prevent iFrameResize to be added to window
    ;(function(undefined) {
        ...
        window.anotea = window.anotea || {};
        window.anotea.iFrameResize = window.iFrameResize || factory();
