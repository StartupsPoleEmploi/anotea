module.exports = {
    stagiaires: db => {
        return Promise.all([
            ...
            db.collection('stagiaires').createIndex({ 'personal.email': 1, 'formation.action.session.id': 1 }),
    ...
    avis: db => {
        return Promise.all([
            ...
            db.collection('avis').createIndex({ 'formation.action.organisme_formateur.label': 1 }),
            ...
            db.collection('avis').createIndex({
                ...
                'formation.action.organisme_formateur.label': 'text',
