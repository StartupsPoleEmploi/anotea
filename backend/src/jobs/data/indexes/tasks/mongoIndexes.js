module.exports = {
    ...
    avis: db => {
        return Promise.all([
            db.collection('avis').createIndex({ 'training.place.postalCode': 1 }),
            ...
            db.collection('avis').createIndex({ 'comment': 1 }),
            db.collection('avis').createIndex({ 'training.formacodes': 1 }),
            db.collection('avis').createIndex({ 'training.idSession': 1 }),
            db.collection('avis').createIndex({ 'training.codeFinanceur': 1 }),
            db.collection('avis').createIndex({ 'training.idFormation': 1 }),
            db.collection('avis').createIndex({ 'training.place.postalCode': 1 }),
            db.collection('avis').createIndex({ 'training.organisation.siret': 1 }),
            db.collection('avis').createIndex({ 'training.organisation.label': 1 }),
            db.collection('avis').createIndex({ 'training.certifInfos': 1 }),
            ...
            db.collection('avis').createIndex({ 'training.startDate': 1 }),
            db.collection('avis').createIndex({ 'training.scheduledEndDate': 1 }),
