...
describe(__filename, withMongoDB(({ getTestDatabase, getTestFile, getComponents }) => {
    ...
    it('should get La Bonne Boite link with a training having a postal code without INSEE mapping', async () => {
        ...
        assert.strictEqual(await externalLinks(db, communes).getLink(stagiaire, 'lbb'), 'https://labonneboite.pole-emploi.fr/entreprises/commune/84080/rome/A1101?d=30');
    });
    ...
    it('should get Offres Pôle Emploi link with a training having a postal code without INSEE mapping', async () => {
        ...
        assert.strictEqual(await externalLinks(db, communes).getLink(stagiaire, 'pe'),
    ...
    it('should get Clara link', async () => {
        ...
        assert.strictEqual(await externalLinks(db, communes).getLink(stagiaire, 'clara'), 'https://clara.pole-emploi.fr');
    });
